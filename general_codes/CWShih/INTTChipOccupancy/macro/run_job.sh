...
root.exe -q -b Fun4All_Intt_ChipOccupancy.C\(${process},${runnumber},${nEvents},\"${output_directory}\",\"${input_directory}\",\"${input_filename}\"\)
...
echo all done process the Fun4All_Intt_ChipOccupancy.C, process_id ${process_id}
