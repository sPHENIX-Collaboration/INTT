...
//  -*- C++ -*-.
#ifndef INTTBCORESOLUTION_H
#define INTTBCORESOLUTION_H
...
class INTTBcoResolution : public SubsysReco
{
 public:

    INTTBcoResolution(
        const std::string &name = "INTTBcoResolution",
