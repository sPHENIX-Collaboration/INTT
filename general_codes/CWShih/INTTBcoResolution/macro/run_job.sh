...
export MYINSTALL=/sphenix/user/ChengWei/INTT/INTT/general_codes/CWShih/INTTBcoResolution/build/install
...
root.exe -q -b Fun4All_Intt_BcoCheck.C\(${process},${runnumber},${nEvents},\"${output_directory}\",\"${input_directory}\",\"${input_filename}\"\)
...
echo all done process the Fun4All_Intt_BcoCheck.C, process_id ${process_id}
