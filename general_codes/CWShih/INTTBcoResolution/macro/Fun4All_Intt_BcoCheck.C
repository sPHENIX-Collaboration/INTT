#include "Fun4All_Intt_BcoCheck.hh"
...
void Fun4All_Intt_BcoCheck(
  ...
  string hot_channel_full_file_directory = "/sphenix/user/jaein213/macros/inttcalib/test/hotmap_cdb_1106/hotmap_run_00054373.root",
  bool apply_hot_channel = true,
  bool clone_hit_remove = false,
...
)
{
  ...
  INTTBcoResolution * IBR = new INTTBcoResolution (
    "INTTBcoResolution",
    process_id,
    run_num,
    output_directory,
