...
echo input_checkHL_file: ${input_checkHL_file}

root.exe -q -b Fun4All_Intt_HitMapEvt.C\(${process},${runnumber},${nEvents},\"${output_directory}\",\"${input_directory}\",\"${input_filename}\",\"${input_checkHL_file}\"\)
