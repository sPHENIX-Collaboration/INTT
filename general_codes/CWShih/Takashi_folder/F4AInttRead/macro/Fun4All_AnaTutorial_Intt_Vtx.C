...
#include <intt/InttVertexFinder.h>
...
int Fun4All_AnaTutorial_Intt_Vtx(
    const int nEvents = 1000, //100000, //20000, // 5000, //5,
...
//--  se->registerSubsystem(anaTutorial);
  ...
  InttVertexFinder *inttvtx = new InttVertexFinder();
  //inttvtx->Verbosity(1);
  inttvtx->setBeamCenter(0.0, 0.0);
  se->registerSubsystem(inttvtx);
