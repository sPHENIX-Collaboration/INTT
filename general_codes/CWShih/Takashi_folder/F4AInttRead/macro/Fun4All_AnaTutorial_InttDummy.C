...
#include <anatutorial/InttOfflineDummyData.h>
...
int Fun4All_AnaTutorial_InttDummy(
    //const int nEvents = 2025, //5,
    const int nEvents = 120, //5,
...
//--  if (Enable::TOPOCLUSTER) TopoClusterReco();
  ...
  //  "/sphenix/lustre01/sphnxpro/commissioning/INTT/tmp/beam_inttall-00020444-0000_event_base_ana.root"
  //);
  //se->registerSubsystem(inttraw);
  InttDummyData *inttdummy = new InttDummyData("InttDummy");
  //InttOfflineDummyData *inttdummy = new InttOfflineDummyData("InttOfflineDummy");
