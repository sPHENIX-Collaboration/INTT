...
"../src",
"/sphenix/user/ChengWei/INTT/INTT/general_codes/CWShih/Takashi_folder/F4AInttRead/install/include",
...
"/gpfs/mnt/gpfs02/sphenix/user/ChengWei/INTT/INTT/general_codes/CWShih/Takashi_folder/F4AInttRead/build/",
nullptr
    };
...
class __attribute__((annotate("$clingAutoload$../src/InttEvent.h")))  InttHit;
class __attribute__((annotate("$clingAutoload$../src/InttEvent.h")))  InttEvent;
)DICTFWDDCLS";
