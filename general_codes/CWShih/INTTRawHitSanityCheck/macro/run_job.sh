...
export MYINSTALL=/sphenix/user/ChengWei/INTT/INTT/general_codes/CWShih/INTTRawHitSanityCheck/build/install
...
root.exe -q -b Fun4All_Intt_SanityCheck.C\(${process},${runnumber},${nEvents},\"${output_directory}\",\"${input_directory}\",\"${input_filename}\"\)
...
echo all done process the Fun4All_Intt_SanityCheck.C, process_id ${process_id}
