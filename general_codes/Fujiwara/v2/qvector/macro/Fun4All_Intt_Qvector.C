...
//#include <../src/InttDummyData.h>
//#include <../src/InttSaveTree.h>
...
int Fun4All_Intt_Qvector(
    ...
    const int skip = 0,
    const string &outdir = ".",
			    //const string inputEvent = "/sphenix/tg/tg01/commissioning/INTT/merged_root_files/beam_inttall-00020869-0000_event_base_ana.root"
    const string inputEvent = "/sphenix/user/hachiya/INTT/INTT/general_codes/hachiya/InttEventSync/beam_inttall-00020869-0000_event_base_ana.root"
)
...
// again on the DST in the Flags node under the RUN node
  ...
  // Enable::MBDRECO = Enable::BBC && true
...
//--  if (Enable::TOPOCLUSTER) TopoClusterReco();
  ...
  InttRawData *inttraw = new InttRawData("Inttraw",inputEvent.c_str()
  ...
  //"/sphenix/user/hachiya/INTT/INTT/general_codes/hachiya/InttEventSync/beam_inttall-00020869-0000_event_base_ana.root"
					 //"/sphenix/tg/tg01/commissioning/INTT/merged_root_files/beam_inttall-00020869-0000_event_base_ana.root"
  );
