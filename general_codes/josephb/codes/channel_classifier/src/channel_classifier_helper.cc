...
channel_classifier_helper::channel_classifier_helper()
{
...
void channel_classifier_helper::Reset()
{
	m_evts = 0;
...
InttNameSpace::RawData_s channel_classifier_helper::struct_from_hash(Int_t h)
{
...
Int_t channel_classifier_helper::hash_from_struct(InttNameSpace::RawData_s const& s)
{
	Int_t h = 0;
	int b = 1;
...
Int_t channel_classifier_helper::hash_from_struct(InttNameSpace::Online_s const& s)
{
	return hash_from_struct(InttNameSpace::ToRawData(s));
}

Int_t channel_classifier_helper::hash_from_struct(InttNameSpace::Offline_s const& s)
{
	return hash_from_struct(InttNameSpace::ToRawData(s));
}

void channel_classifier_helper::print(InttNameSpace::RawData_s const& s)
{
...
int channel_classifier_helper::append_file(std::string const& i_filename)
{
	int return_val = 0;
	std::stringstream output;

	output << "int channel_classifier_helper::append_file(std::string const& i_filename)" << std::endl;
...
int channel_classifier_helper::output_hits(std::string const& o_filename)
{
	int return_val = 0;
	std::stringstream output;

	output << "int channel_classifier_helper::output_hits(std::string const& o_filename)" << std::endl;
