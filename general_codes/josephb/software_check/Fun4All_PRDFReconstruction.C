...
void Fun4All_PRDFReconstruction(
    ...
    const int runnumber = 53877, // 53756,
    const std::string &dir = "/.",
    const std::string &outfilename = "output_tracks",
    const std::string &input_gl1file = "list/gl1daq.list",
    const string &input_inttfile00 = "list/intt0.list",
    const string &input_inttfile01 = "list/intt1.list",
    const string &input_inttfile02 = "list/intt2.list",
    const string &input_inttfile03 = "list/intt3.list",
    const string &input_inttfile04 = "list/intt4.list",
    const string &input_inttfile05 = "list/intt5.list",
    const string &input_inttfile06 = "list/intt6.list",
    const string &input_inttfile07 = "list/intt7.list",
    const string &input_mvtxfile00 = "list/mvtx0.list",
    const string &input_mvtxfile01 = "list/mvtx1.list",
    const string &input_mvtxfile02 = "list/mvtx2.list",
    const string &input_mvtxfile03 = "list/mvtx3.list",
    const string &input_mvtxfile04 = "list/mvtx4.list",
    const string &input_mvtxfile05 = "list/mvtx5.list",
    const string &input_tpcfile00 = "list/tpc00.list",
    const string &input_tpcfile01 = "list/tpc01.list",
    const string &input_tpcfile02 = "list/tpc02.list",
    const string &input_tpcfile03 = "list/tpc03.list",
    const string &input_tpcfile04 = "list/tpc04.list",
    const string &input_tpcfile05 = "list/tpc05.list",
    const string &input_tpcfile06 = "list/tpc06.list",
    const string &input_tpcfile07 = "list/tpc07.list",
    const string &input_tpcfile08 = "list/tpc08.list",
    const string &input_tpcfile09 = "list/tpc09.list",
    const string &input_tpcfile10 = "list/tpc10.list",
    const string &input_tpcfile11 = "list/tpc11.list",
    const string &input_tpcfile12 = "list/tpc12.list",
    const string &input_tpcfile13 = "list/tpc13.list",
    const string &input_tpcfile14 = "list/tpc14.list",
    const string &input_tpcfile15 = "list/tpc15.list",
    const string &input_tpcfile16 = "list/tpc16.list",
    const string &input_tpcfile17 = "list/tpc17.list",
    const string &input_tpcfile18 = "list/tpc18.list",
    const string &input_tpcfile19 = "list/tpc19.list",
    const string &input_tpcfile20 = "list/tpc20.list",
    const string &input_tpcfile21 = "list/tpc21.list",
    const string &input_tpcfile22 = "list/tpc22.list",
    const string &input_tpcfile23 = "list/tpc23.list",
    const string &input_tpotfile = "list/tpot.list"
)
{
...
// TPOT
  ...
  Fun4AllOutputManager *out = new Fun4AllDstOutputManager("out", "dstout.root");
