...
o_format="/sphenix/tg/tg01/commissioning/INTT/root_files/beam_intt_combined-dst-%08d-0000.root"
...
root -l "/sphenix/u/jbertaux/sphnx_software/INTT/general_codes/josephb/macros/CombinedRawDataDecoder.C(\"$i_format\", \"$o_format\", $1)"
exit 0
