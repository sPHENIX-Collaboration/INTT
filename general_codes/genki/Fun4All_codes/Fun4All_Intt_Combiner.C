...
void Fun4All_Intt_Combiner(int nEvents = 10,
			   ...
			   )
{
  ...
  // "beam/beam_intt0-00020869-0000.evt"
  ...
  int run = 20869;
  string output_base = "_" + to_string( run ) + "_" + to_string( nEvents ) + "events";
  
  string output_root = "tree" + output_base + ".root";
  string output_dst = "DST_INTT" + output_base + ".root";
  ...
  for (auto iter : infile)
    {
      ...
      // sngl->AddFile( "/sphenix/lustre01/sphnxpro/commissioning/INTT/beam/beam_intt0-00020869-0000.evt" );
