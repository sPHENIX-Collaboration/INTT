...
void adc_ampl6(const char *fname = "fphx.root") {
	...
	double y[8] = { 226., 234., 242., 250., 258., 266., 274., 282. };
	double yj[8] = { 0.0 };
	...
	g2->GetYaxis()->SetLimits(220, 290);
	g2->Draw("AP");

	TCanvas * 3 = new TCanvas("c3", "adc vs ampl", 600, 450);
	TH2D *h2 = new TH2D("h2", "adc vs amplitude", 70, 0, 70, 8, 0, 8);
	tree->Draw("adc:ampl>>h2", "fem_id==4&&module==8&&ampl<64&&fpga_id==0", "box");
