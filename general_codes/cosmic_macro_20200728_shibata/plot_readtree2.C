{
	...
	TCanvas *c1 = new TCanvas("c1", "energy loss", 1000, 280);
		TFile *rootfile = TFile::Open("/Users/sphenix/Documents/INTT_testbench/data/histofphx_raw_20200727-1917_0.root");
	//string raw_data = "/Users/sphenix/Documents/INTT_testbench/data/histofphx_raw_20200727-1917_0.root";
	//string hist_data = "C:/root_v5.34.36/macros/cosmic_macro_20200728_shibata/"
	//	+ "histo" + input.substr(raw_data.find_last_of("/") + 1, raw_data.size() - raw_data.find_last_of("/") - 1);

	TFile *rootfile = TFile::Open( hist_data.c_str() );
