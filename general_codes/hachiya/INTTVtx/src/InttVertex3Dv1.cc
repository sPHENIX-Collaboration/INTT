#include "InttVertex3Dv1.h"

#include <cmath>

InttVertex3Dv1::InttVertex3Dv1()
  : _id(0xFFFFFFFF)
{
...
void InttVertex3Dv1::identify(std::ostream& os) const
{
  os << "---InttVertex3Dv1--------------------------------" << std::endl;
...
int InttVertex3Dv1::isValid() const
{
...
void InttVertex3Dv1::set_error(unsigned int i, unsigned int j, float value)
{
  _err[covar_index(i, j)] = value;
  return;
}

float InttVertex3Dv1::get_error(unsigned int i, unsigned int j) const
{
  return _err[covar_index(i, j)];
}

unsigned int InttVertex3Dv1::covar_index(unsigned int i, unsigned int j) const
{
  if (i > j)
  {
    std::swap(i, j);
