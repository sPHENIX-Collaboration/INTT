...
int InttXYVertexFinder::process_event(PHCompositeNode* topNode)
{
  ...
  auto vertex_quad = std::make_unique<InttVertex3Dv1>();
  ...
  auto vertex_line = std::make_unique<InttVertex3Dv1>();
...
int InttXYVertexFinder::createNodes(PHCompositeNode* topNode)
{
  ...
  m_inttvertexmap = findNode::getClass<InttVertex3DMap>(inttNode, "InttVertexMap");
  if (!m_inttvertexmap)
  {
    m_inttvertexmap = new InttVertex3DMapv1();
