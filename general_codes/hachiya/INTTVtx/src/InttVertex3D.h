...
class InttVertex3D : public Vertex
{
 public:
  ...
  virtual double get_chi2ndf() const  { return NAN; }
  virtual void   set_chi2ndf(double) {}

  virtual double get_width() const  { return NAN; }
  ...
  virtual double get_peakratio() const  { return NAN; }
  virtual void   set_peakratio(double) {}

  virtual double get_peakwidth() const  { return NAN; }
