...
{  
 ...
 // G4LogicalVolume* INTT_ChipLV[4];
 // G4String INTT_ChipLV_name[4]={"INTT_ChipLV1","INTT_ChipLV2","INTT_ChipLV3","INTT_ChipLV4"};
 ...
 testbeam_BOX_rotation_Y->rotateY(90.*deg);
 //===============================================================================================================
              ...
              if (l2<8)
                {
                    ...
                    G4cout<<"copy test : "<<counting_number<<" ID : "<<l<<" "<<l1<<" "<<l2<<" position : "<<the_position[0]<<" "<<the_position[1]<<" "<<the_position[2]<<" up : "<<0<<" type : "<<0<<G4endl;
                    counting_number+=1;
              ...
              else 
                {
                    ...
                    new G4PVPlacement(0, 
                                      ...
                                      false);
                    the_position = INTT_testbeam_BOXPV->GetTranslation()+INTT_siLV_outer_allPV->GetTranslation()+chip_channelsPV->GetTranslation();
                    G4cout<<"copy test : "<<counting_number<<" ID : "<<l<<" "<<l1<<" "<<l2<<" position : "<<the_position[0]<<" "<<the_position[1]<<" "<<the_position[2]<<" up : "<<0<<" type : "<<1<<G4endl;
                    counting_number+=1;
                }  
            }
        }
              ...
              if (l2<8)
                {
                    ...
                    new G4PVPlacement(0, 
                                      ...
                                      false);
                    the_position = INTT_testbeam_BOXPV->GetTranslation()+INTT_siLV_outer_allPV->GetTranslation()+chip_channelsPV->GetTranslation();
                    G4cout<<"copy test : "<<counting_number<<" ID : "<<l<<" "<<l1<<" "<<l2<<" position : "<<the_position[0]<<" "<<the_position[1]<<" "<<the_position[2]<<" up : "<<1<<" type : "<<0<<G4endl;
                    counting_number+=1;
              ...
              else 
                {
                    ...
                    new G4PVPlacement(0, 
                                      ...
                                      false);
                    the_position = INTT_testbeam_BOXPV->GetTranslation()+INTT_siLV_outer_allPV->GetTranslation()+chip_channelsPV->GetTranslation();
                    G4cout<<"copy test : "<<counting_number<<" ID : "<<l<<" "<<l1<<" "<<l2<<" position : "<<the_position[0]<<" "<<the_position[1]<<" "<<the_position[2]<<" up : "<<1<<" type : "<<1<<G4endl;
                    counting_number+=1;
                }  
            }
