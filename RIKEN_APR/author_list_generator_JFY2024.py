...
class People:
    def __init__( self ) :
        ...
        self.persons_.append( Person( first="Y.",    family="Fujino",     affiliations=["RIKEN", "Rikkyo" ] ) )
        ...
        self.persons_.append( Person( first="T.",    family="Harada",     affiliations=["RIKEN", "Rikkyo" ] ) )
        ...
        self.persons_.append( Person( first="Y.",    family="Ishigaki",   affiliations=["NWU"             ] ) )
        ...
        self.persons_.append( Person( first="I.",    family="Omae",       affiliations=["NWU"             ] ) )
        ...
        self.persons_.append( Person( first="C.~W.", family="Shih",       affiliations=["RIKEN", "NCU"    ] ) )
        ...
        self.persons_.append( Person( first="H.",    family="Yanagawa",   affiliations=["RIKEN", "Rikkyo" ] ) )
